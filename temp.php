                                    ...
                                    <div class="flex flex-col gap-4 h-full">
                                        <div class="lg:flex items-center justify-between mb-4 gap-3">
                                            <div class="mb-4 lg:mb-0">
                                                <h3>Đơn hàng </h3>
                                                <p>Xem doanh số bán hàng &amp; tổng quan dữ liệu trong 30 ngày gần nhất</p>
                                            </div>
                                        ...
                                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                            <div class="card card-layout-frame">
                                                ...
                                                <div class="card-body">
                                                    <h6 class="font-semibold mb-4 text-sm">Tổng doanh thu trong ngày hôm nay</h6>
                                                    <div class="flex justify-between items-center">
                                                        <div>
                                                            <h3 class="font-bold">
                                                                <span><?php echo number_format($toal_oder_revenue['tong_gia_don_hang'], 0, ',', '.').'đ' ?> </span>
                                                            </h3>
                                            ...
                                            <div class="card card-layout-frame">
                                                <div class="card-body">
                                                    <h6 class="font-semibold mb-4 text-sm">Tổng doanh thu 7 ngày qua</h6>
                                                    <div class="flex justify-between items-center">
                                                        <div>
                                                            <h3 class="font-bold">
                                            ...
                                            <div class="card card-layout-frame">
                                                <div class="card-body">
                                                    <h6 class="font-semibold mb-4 text-sm">Tổng doanh thu trong 1 tháng</h6>
                                                    <div class="flex justify-between items-center">
                                                        <div>
                                                            <h3 class="font-bold">
                                                            ...
                                                            <br>
                                                            <p>Chỉ tính những đơn hàng đã có trạng thái<span class="font-semibold"> Thành công hoặc, Xác thực</span></p>
                                                        </div>

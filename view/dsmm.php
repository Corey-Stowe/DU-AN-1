                    ...
                    <tr class="border">
                        ...
                        <th scope="row" class=" ps-xl-10 py-6 d-flex align-items-center border-0">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="ms-6 me-7">
                                    <img src="#" data-src="image/<?php echo $anh?>" class="img-fluid lazy-image"
                                        height="100" width="75" alt>
                                </div>
                                <div>
                                    <p class=" text-body-emphasis fw-semibold mb-5"><?php echo $ten_san_pham?></p>
                                    <p class="fw-bold fs-14px mb-4 text-body-emphasis">
                                        <span
                                            class=" fw-normal fs-13px text-decoration-line-through text-secondary pe-3"><?php echo number_format($don_gia, 0, ',', '.').'đ' ?></span>
                    ...
                    <tr class="border">
                        ...
                        <td class=" align-middle text-end pe-10">
                            ...
                            <a href="index.php?act=ctsp&ma_san_pham=<?php echo $ma_san_pham?>"
                                class="btn fs-15px px-9 lh-sm btn-outline-dark">Xem sản phẩm</a>
                        </td>
                    </tr>
                    <?php
                        }

    ...
    <div class="success-message-container">
        <?php
            if (isset($trang_thai_don['trang_thai_don']) && $trang_thai_don['trang_thai_don'] == 0) {
                ?>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#d2c932"
            aria-hidden="true" class="w-6 h-6 success-icon" height="300px">
        ...
        <div class="text-container">
            ...
            <p class="text-gray-700 dark:text-gray-400">Cảm ơn bạn đã mua hàng tại <a href="index.php"
                    class="text-green-600 hover:underline">Shop</a>.</p>
            <p class="text-gray-700 dark:text-gray-400">Mã đơn hàng của bạn là <a
                    href="index.php?act=chitietdh&ma_don_hang=<?php echo $ma_don_hang ?>"
                    class="text-green-600 hover:underline">#<?php echo $ma_don_hang ?></a>.</p>
            <p class="text-gray-700 dark:text-gray-400">Chúng tôi sẽ liên hệ với bạn trong thời gian sớm nhất.</p>
            <button class="btn btn-primary"><a href="index.php?act=chitietdh&ma_don_hang=<?php echo $ma_don_hang ?>">Xem
                    chi tiết đơn hàng</a></button>
            ...
            ?>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#4e7661"
                aria-hidden="true" class="w-6 h-6 success-icon" height="300px">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="text-container">
                ...
                <button class="btn btn-primary"><a
                        href="index.php?act=chitietdh&ma_don_hang=<?php echo $ma_don_hang ?>">Xem chi tiết đơn
                        hàng</a></button>
                <button class="btn btn-secondary"><a href="index.php">Tiếp tục mua hàng</a></button>
                <?php
            }
            ...
            ?>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="#ca1616" aria-hidden="true" class="w-6 h-6 success-icon" height="300px">
                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="text-container">
                    ...
                    <p class="text-gray-700 dark:text-gray-400">Cảm ơn bạn đã mua hàng tại <a href="index.php"
                            class="text-green-600 hover:underline">Shop</a>.</p>
                    <button class="btn btn-primary"><a
                            href="index.php?act=retry_payment&ma_don_hang=<?php echo $ma_don_hang ?>">Thanh toán lại
                        </a></button>
                    <button class="btn btn-secondary"><a
                            href="index.php?act=chitietdh&ma_don_hang=<?php echo $ma_don_hang ?>">Chi Tiết Đơn
                            hàng</a></button>
                    <?php
            }
            ?>

        ...
        <div class="z-index-2 container container-xxl py-21 pt-xl-10 pb-xl-11">
          <div class="hero-content text-start">
            <div data-animate="fadeInDown">
              <p class="text-body-emphasis mb-8 text-uppercase fw-semibold fs-15px"><?php echo $ten_banner ?></p>
             
            </div>
            <a href="<?php echo $lien_ket?>" data-animate="fadeInUp" class="btn btn-lg btn-dark btn-hover-bg-primary btn-hover-border-primary"> Mua Ngay </a>
          </div>
        </div>
        <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100   light-mode-img" data-bg-src="image/<?php echo $hinh_anh ?>"></div>
        <div class="lazy-bg bg-overlay dark-mode-img position-absolute z-index-1 w-100 h-100" data-bg-src="image/<?php echo $hinh_anh ?>"></div>
      </div>
      <?php
        }
      ?>
  ...
  <section>
    <div class="container container-xxl py-lg-17 pt-14 pb-16">
      <div class="mb-13 pb-3 text-center" data-animate="fadeInUp">
        <h2 class="mb-5">Sản phảm hot nhất trong tháng</h2>
        <p class="fs-18px mb-0">chọn một sản phẩm mà bạn thích nhất</p>
      </div>
          ...
          <div class="card card-product grid-1 bg-transparent border-0" data-animate="fadeInUp">
            ...
            <div class="card-body text-center p-0">
              ...
              <h4 class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                <a class="text-decoration-none text-reset" href="shop/product-details-v1.html"><?php echo $ten_san_pham?></a>
              </h4>
    ...
    <div class="row gy-30px">
      <div class="col-lg-6" data-animate="fadeInUp">
        <div class="card border-0 rounded-0 banner-01 hover-zoom-in hover-shine">
          ...
          <img class="lazy-image dark-mode-img object-fit-cover card-img" src="#" data-src="./assets/images/banner/banner-white-01.jpg" width="690" height="420" alt="Intensive Glow C&#43; Serum">
          <div class="card-img-overlay d-inline-flex flex-column p-md-12 m-md-2 p-8">
            <h6 class="card-subtitle ls-1 fs-15px mb-5 fw-semibold text-body-calculate">NEW COLLECTION</h6>
            <h3 class="card-title lh-45px mw-md-60 pe-xl-15  fs-3 pe-0">Intensive Glow C&#43; Serum</h3>
            <div class="mt-7">
              <a href="#" class="btn btn-white px-6 shadow-sm">Explore More</a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-6" data-animate="fadeInUp">
        <div class="card border-0 rounded-0 banner-01 hover-zoom-in hover-shine">
          ...
          <img class="lazy-image dark-mode-img object-fit-cover card-img" src="#" data-src="./assets/images/banner/banner-white-02.jpg" width="690" height="420" alt="25% off Everything">
          <div class="card-img-overlay d-inline-flex flex-column p-md-12 m-md-2 p-8">
            <h3 class="card-title lh-45px fs-3 pe-15">25% off Everything</h3>
            <p class="card-text fs-15px text-body-emphasis mw-md-60 pe-xl-20">Makeup with extended range in colors for every human.</p>
            <div class="mt-7">
              <a href="#" class="btn btn-white shadow-sm">Shop Sale</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-5 mb-10 mb-lg-0" data-animate="fadeInUp">
          <div class="card border-0 rounded-0 hover-zoom-in hover-shine">
            ...
            <img class="lazy-image dark-mode-img w-100 img-fluid card-img object-fit-cover banner-02" src="#" data-src="./assets/images/banner/banner-white-33.jpg" width="570" height="913" alt="Empower Yourself">
            ...
            <div class="col-md-4 col-sm-6 col-12">
              <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                ...
                <div class="card-body text-center p-0">
                  ...
                  <h4 class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                    <a class="text-decoration-none text-reset" href="shop/product-details-v1.html">Enriched Duo</a>
                  </h4>
                  <div class="d-flex align-items-center fs-12px justify-content-center">
                    <div class="rating">
                      <div class="empty-stars">
            ...
            <div class="col-md-4 col-sm-6 col-12">
              <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                ...
                <div class="card-body text-center p-0">
                  <span class="d-flex align-items-center price text-body-emphasis fw-bold justify-content-center mb-3 fs-6">$29.00</span>
                  <h4 class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                    <a class="text-decoration-none text-reset" href="shop/product-details-v1.html">Shield Spray</a>
                  </h4>
                  <div class="d-flex align-items-center fs-12px justify-content-center">
                    <div class="rating">
                      <div class="empty-stars">
            ...
            <div class="col-md-4 col-sm-6 col-12">
              <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                <figure class="card-img-top position-relative mb-7 overflow-hidden">
                  ...
                  <div class="position-absolute product-flash z-index-2 ">
                    <span class="badge badge-product-flash on-sale bg-primary">-26%</span>
                  </div>
                  <div class="position-absolute d-flex z-index-2 product-actions  vertical">
                    <a class="text-body-emphasis bg-body bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm quick-view sm" href="#" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Quick View">
                      <span data-bs-toggle="modal" data-bs-target="#quickViewModal" class="d-flex align-items-center justify-content-center">
                ...
                <div class="card-body text-center p-0">
                  ...
                  <h4 class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                    <a class="text-decoration-none text-reset" href="shop/product-details-v1.html">Vital Eye Cream</a>
                  </h4>
                  <div class="d-flex align-items-center fs-12px justify-content-center">
                    <div class="rating">
                      <div class="empty-stars">
            ...
            <div class="col-md-4 col-sm-6 col-12">
              <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                ...
                <div class="card-body text-center p-0">
                  ...
                  <h4 class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                    <a class="text-decoration-none text-reset" href="shop/product-details-v1.html">Supreme Moisture Mask</a>
                  </h4>
                  <div class="d-flex align-items-center fs-12px justify-content-center">
                    <div class="rating">
                      <div class="empty-stars">
            ...
            <div class="col-md-4 col-sm-6 col-12">
              <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                ...
                <div class="card-body text-center p-0">
                  <span class="d-flex align-items-center price text-body-emphasis fw-bold justify-content-center mb-3 fs-6">$29.00</span>
                  <h4 class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                    <a class="text-decoration-none text-reset" href="shop/product-details-v1.html">Supreme Polishing Treatment</a>
                  </h4>
                  <div class="d-flex align-items-center fs-12px justify-content-center">
                    <div class="rating">
                      <div class="empty-stars">
            ...
            <div class="col-md-4 col-sm-6 col-12">
              <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                ...
                <div class="card-body text-center p-0">
                  <span class="d-flex align-items-center price text-body-emphasis fw-bold justify-content-center mb-3 fs-6">$29.00</span>
                  <h4 class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                    <a class="text-decoration-none text-reset" href="shop/product-details-v1.html">Scalp Moisturizing Cream</a>
                  </h4>
                  <div class="d-flex align-items-center fs-12px justify-content-center">
                    <div class="rating">
                      <div class="empty-stars">
  ...
  <section class="pt-14 pb-md-12 pb-8 pb-lg-17 pt-lg-21">
    <div class="container container-xxl">
      <div class="text-center" data-animate="fadeInUp">
        ...
        <p class="fs-18px w-lg-60 w-xl-40 mx-md-16 mx-lg-auto mb-13">Our bundles were designed to conveniently package your tanning essentials while saving you money.</p>
      </div>
      <div class="row">
          ...
          <div class="card border-0">
            ...
            <div class="card-body text-body-emphasis text-center pt-9 mt-2">
              <h5 class="card-titletext-decoration-none fs-4 mb-4 d-block fw-semibold">
                <a class="color-inherit text-decoration-none" href="#">Summer Collection</a>
              </h5>
              <a href="#" title="Shop now" class="btn btn-link fw-semibold text-body-emphasis">Shop now <i class="far fa-arrow-right fs-14px ps-2 ms-1"></i>
              </a>
            </div>
          </div>
        </div>
        <div class="col-md-6 mb-8 mb-md-0" data-animate="fadeInUp">
          <div class="card border-0">
            ...
            <div class="card-body text-body-emphasis text-center pt-9 mt-2">
              ...
              <a href="#" title="Shop now" class="btn btn-link fw-semibold text-body-emphasis">Read more <i class="far fa-arrow-right fs-14px ps-2 ms-1"></i>
              </a>
            </div>
          </div>
        </div>

...
<main id="content" class="wrapper layout-page">
        ...
        <div class="container container-xxl">
            <div class="row align-items-end">
                <div class="col-lg-4 order-2 order-lg-1 px-xl-6 pb-16 pt-12 py-lg-18 py-xl-22" data-animate="fadeInUp">
                    <div class="text-left">
                        <p class="fs-15px mb-6 ls-1 text-body-emphasis fw-semibold">BỘ SƯU TẬP MỚI Đông Xuân Nữ 2024</p>
                        <h2 class="fs-20 w-md-50 w-lg-100 w-xl-80 mb-4 me-7 me-md-25">Dầm & Chân Váy Nữ</h2>
                        <p class="fs-18px mb-0 text-body-calculate">Khám Phá bộ sưu tập thời trang nữ mới trẻ trung</p>
                    </div>
                ...
                <div class="col-lg-8 order-1 order-lg-2" data-animate="fadeIn">
                    <img class="lazy-image img-fluid light-mode-img size-img" src="#"
                        data-src="image/hmgoepprod (43).jpg" width="923" height="640" alt="other-01">
                    <img class="lazy-image dark-mode-img img-fluid size-img" src="#"
                        data-src="image/hmgoepprod (43).jpg" width="923" height="640" alt="other-01">
                </div>
                <br>
            </div>
    ...
    <section class="bg-section-3 dark-mode-bg">
        <div class="container container-xxl">
            <div class="row align-items-end">
                <div class="col-lg-4 order-2 order-lg-1 px-xl-6 pb-16 pt-12 py-lg-18 py-xl-22" data-animate="fadeInUp">
                    <div class="text-left dark-mode-text">
                        <p class="fs-15px mb-6 ls-1 text-body-emphasis fw-semibold">BỘ SƯU TẬP MỚI Đông Xuân Nam 2024
                        </p>
                        <h2 class="fs-20 w-md-50 w-lg-100 w-xl-80 mb-4 me-7 me-md-25">Quần Dài & Áo Nam</h2>
                        <p class="fs-18px mb-0 text-body-calculate">Khám Phá bộ sưu tập thời trang nam mới bền bỉ</p>
                    </div>
                    <a href="index.php?act=listspdm&ma_loai=24" class="mt-10 btn btn-dark shadow-sm">Khám phá ngay</a>
                </div>
                <div class="col-lg-8 order-1 order-lg-2 dark-mode-bg" data-animate="fadeIn">
                    <img class="lazy-image img-fluid dark-mode-img size-img" src="#" data-src="image/hmgoepprod (5).jpg"
                        width="923" height="640" alt="other-01">
                    <img class="lazy-image light-mode-img img-fluid size-img" src="#"
                        data-src="image/hmgoepprod (5).jpg" width="923" height="640" alt="other-01">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="pt-14 pb-14 pt-lg-19 pb-lg-16">
            <div class="container container-xxl mb-13 d-xl-flex">
                <div class="flex-grow-1 text-left" data-animate="fadeInUp">
                    ...
                    <p class="fs-18px mb-0 mw-xl-40 mw-lg-50 mw-md-75">Bạn đang tìm kiếm một cái gì đó cụ thể? Mua
                        sắm
                        theo sản phẩm bán chạy nhất để tìm thấy món đồ hoàn hảo của bạn!</p>
                </div>
            </div>
    ...
    <section class="container container-xxl pt-15 pb-16 pb-lg-18 pt-lg-19">
        ...
        <div class="text-center mt-10">
            <a href="index.php?act=listspdm&ma_loai=all" target="_blank" class="btn btn-outline-dark"> Danh sách tất
                cả
                loại hàng </a>
        </div>
    </section>
        ...
        <div class="container container-xxl">
            <div class="row align-items-center">
                <div class="col-lg-7 position-relative" data-animate="fadeIn">
                    <img class="lazy-image img-fluid light-mode-img" src="#" data-src="image/<?php echo $anh ?>"
                        width="774" height="640" alt="Countdown">
                    <img class="lazy-image dark-mode-img img-fluid" src="#" data-src="image/<?php echo $anh ?>"
                        width="774" height="640" alt="Countdown">
                ...
                <div class="col-lg-5 py-lg-0 py-13" data-animate="fadeInUp">
                    ...
                    <a href="index.php?act=ctsp&ma_san_pham=<?php echo $ma_san_pham ?>"
                        class="mt-11 btn btn-white shadow-sm">Mua
                        sản phẩm với giá
                        <?php echo number_format($giam_gia, 0, ',', '.') . 'đ' ?>
                    </a>
                </div>
            ...
            <form class="mx-auto" style="max-width: 546px" data-animate="fadeInUp">
                <div class="text-center">
                    <div class=" input-group position-relative mb-11 form-border-transparent">
                        ...
                        <button type="submit"
                            class=" btn btn-dark btn-hover-bg-primary btn-hover-border-primary rounded ms-0">Đăng
                            ký
                            ngay</button>
                    </div>
                    <div class="form-check d-flex justify-content-center">
                        <input class="form-check-input me-4 rounded" type="checkbox" value id="flexCheckDefault">
                        <label class="form-check-label text-body fs-14px" for="flexCheckDefault"> Tôi đồng ý <a href="#"
                                class="text-decoration-none text border-bottom">điều khoản & dịch vụ</a> và
                            <a href="#" class="text-decoration-none border-bottom">bảo vệ dữ liệu</a>
                        </label>
                    </div>
                </div>
            </form>
                ...
                <div class="col-xl-3 col-md-6" data-animate="fadeInUp">
                    <div class="icon-box icon-box-style-1 card border-0 text-center">
                        ...
                        <div class="icon-box-content card-body pt-4">
                            ...
                            <p class="icon-box-desc card-text fs-18px mb-0">Miễn phí ship từ các đơn hàng 200.000
                                VND
                                trở lên</p>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-md-6" data-animate="fadeInUp">
                    <div class="icon-box icon-box-style-1 card border-0 text-center">
                        ...
                        <div class="icon-box-content card-body pt-4">
                            ...
                            <p class="icon-box-desc card-text fs-18px mb-0">Với 30 ngày hoàn trả nếu sản phẩm có
                                lỗi.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-md-6" data-animate="fadeInUp">
                    <div class="icon-box icon-box-style-1 card border-0 text-center">
                        ...
                        <div class="icon-box-content card-body pt-4">
                            ...
                            <p class="icon-box-desc card-text fs-18px mb-0">Thanh toán COD, Thẻ tín dụng và VNPay
                            </p>
                        </div>
                    </div>
                </div>

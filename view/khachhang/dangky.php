            ...
            <div class="col-lg-5 col-md-8 mx-auto">
                <form action="index.php?act=register" method="post">
                    ...
                    <div class="mb-7">
                        ...
                        <input name="repassword" id="password" type="password" class="form-control"
                            placeholder="Password">
                    </div>
                    <div class="form-check mb-7">
                        <input name="agree" type="checkbox" class="form-check-input rounded-0" id="agree_terms">
                        <label class="form-check-label text-secondary" for="agree_terms" required> Tôi đồng ý <a
                                href="#" class="text-decoration-underline">Điều khoản</a> Và <a href="#"
                                class="text-decoration-underline">Dịch Vụ</a>
                        </label>
                    </div>

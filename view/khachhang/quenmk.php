        ...
        <div class="bg-body-secondary py-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-site py-0 d-flex justify-content-center">
                    ...
                    <li class="breadcrumb-item active pl-0 d-flex align-items-center" aria-current="page">Quên mật khẩu
                    </li>
                </ol>
                    ...
                    <div class="row no-gutters">
                        <div class="col-lg-6 mb-15 mb-lg-0 pe-xl-2">
                            ...
                            <form class action="index.php?act=ifogor" method="post">
                                <label for="user_login_password" class="">Nếu địa chỉ email này tồn tại chúng tôi sẽ gửi
                                    một liên kết đổi mật khẩu</label>
                                <br>
                                ...
                                <button type="submit" class="btn btn-primary w-100 mb-7" name="submit">Gửi liên
                                    kết</button>

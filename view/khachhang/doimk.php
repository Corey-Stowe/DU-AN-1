        ...
        <div class="bg-body-secondary py-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-site py-0 d-flex justify-content-center">
                    ...
                    <li class="breadcrumb-item active pl-0 d-flex align-items-center" aria-current="page">Đổi Mật Khẩu
                    </li>
                </ol>
                ...
                <div class="col-lg-10 mx-auto">
                    <div class="row no-gutters">
                        <div class="col-lg-6 mb-15 mb-lg-0 pe-xl-2">
                            ...
                            <form class action="index.php?act=resetpass&session=<?php echo $_GET['session']?>"
                                method="post">
                                ...
                                <div class="form-group mb-6">
                                    ...
                                    <input type="password" class="form-control" id="user_login_email" name="password"
                                        placeholder="Mật khẩu mới">
                                </div>
                                <div class="form-group mb-6">
                                    <label for="user_login_email" class="visually-hidden">Nhập lại mật khẩu mới</label>
                                    <input type="password" class="form-control" id="user_login_email" name="repassword"
                                        placeholder="Nhập lại mật khẩu mới">
                                </div>
                                <button type="submit" class="btn btn-primary w-100 mb-7" name="submit">Đổi Mât
                                    Khẩu</button>

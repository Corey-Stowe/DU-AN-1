                ...
                <div class="card-body py-10 px-8 my-10 border">
                    ...
                    <div class="input-group position-relative">
                        <form action="index.php?act=coupon" method="POST">
                            <input type="code" name="magiam" class="form-control bg-body rounded-end"
                                placeholder="Mã giảm giá">
                            <button type="submit" name="code"
                                class="btn btn-dark btn-hover-bg-primary btn-hover-border-primary"> Áp dụng mã giảm giá
                            </button>
                            <?php
                    if(isset($error)){
            ...
            <div class="row">
              ...
              ?>
                            <div class="d-flex w-100 mb-7">
                                <div class="me-6">
                                    <img src="#" data-src="image/<?php echo $anh?>" class="lazy-image" width="60"
                                        height="80" alt="Natural Coconut Cleansing Oil">
                                </div>
                                <div class="d-flex flex-grow-1">
                                    <div class="pe-6">
                                        <a href="#" name="ten_san_pham" class><?php echo $ten_san_pham?> <span
                                                class="text-body"> x<?php echo $so_luong?></span>
                                        </a>
                                        </p>
                                    </div>
                                    <div class="ms-auto">
                                        <p class="fs-14px text-body-emphasis mb-0 fw-bold">
                                            <?php echo number_format($giam_gia, 0, ',', '.').'đ' ?></p>
          ...
          if(isset($total)){
            ...
            echo '0đ';
                ...
                <div class="col-lg-8 order-lg-first pe-xl-20 pe-lg-6">
                    <div class="checkout">
                        <p>Bạn có mã giảm giá? <a data-bs-toggle="collapse" href="#collapsecoupon" role="button"
                                aria-expanded="false" aria-controls="collapsecoupon">Bấm vào đây để áp dụng</a>
                        </p>
           ...
           ?>
                        ...
                        <div class="mb-7">
                            <div class="row">
                                <div class="col-md-4 mb-md-0 mb-7">
                                    <label for="city"
                                        class="mb-5 fs-13px letter-spacing-01 fw-semibold text-uppercase">Huyện/Xã</label>
                                    <input type="text" class="form-control" id="city" name="huyen" required>
                                </div>
                                <div class="col-md-4 mb-md-0 mb-7">
                                    <label for="state"
                                        class="mb-5 fs-13px letter-spacing-01 fw-semibold text-uppercase">Tỉnh</label>
                                    <input type="text" class="form-control" id="state" name="tinh" required>
                                </div>
                                <div class="col-md-4">
                                    <label for="zip"
                                        class="mb-5 fs-13px letter-spacing-01 fw-semibold text-uppercase">Mã bưu
                                        chính</label>
                        ...
                        <div class="mb-7">
                            <label class="mb-5 fs-13px letter-spacing-01 fw-semibold text-uppercase">Thông Tin liên
                                hệ</label>
                            <div class="row">
                                <div class="col-md-6 mb-md-0 mb-7">
            ...
            ?>
                    ...
                    <div class="mb-7">
                        <div class="row">
                            <div class="col-md-8 mb-md-0 mb-7">
                                <label for="street-address"
                                    class="mb-5 fs-13px letter-spacing-01 fw-semibold text-uppercase">Địa Chỉ</label>
                                <input type="text" class="form-control" id="street-address" name="diachi"
                    ...
                    <div class="mb-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="number" class="form-control" id="phone" name="makh"
                                    placeholder="Số điện thoại" value="<?php echo $ma_khach_hang?>" hidden>
                            </div>
                        </div>
                    </div>
                    <div class="mt-6 mb-5 form-check">
            ...
            ?>
                <div class="checkout mb-7">
                    <div class="mb-7">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Ghi chú"
                            name="ghichu_kh"></textarea>
                    </div>
                </div>
                <div class="checkout mb-7">
                    <div class="mb-7">
                        ...
                        <div class="nav nav-tabs border-0">
                            <select class="form-select" id="payment" name="phuong_thuc">
                                <option value="0" selected><a class="btn btn-payment px-12 mx-2 py-6 me-7 my-3 nav-link"
                                        data-bs-toggle="tab" data-bs-target="#cod-tab">

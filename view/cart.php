...
<div class="d-flex w-100 mb-7">
<div class="me-6">
<img src="#" data-src="../assets/images/others/shopping-cart-03.jpg" class="lazy-image" width="60" height="80" alt="Cleansing Balm">
</div>
<div class="d-flex flex-grow-1">
<div class="pe-6">
...
<a href="#" class="form-select dropdown-toggle d-flex justify-content-between align-items-center text-decoration-none text-secondary p-5 position-relative d-block" role="button" data-bs-toggle="dropdown" aria-expanded="false">
Viet Nam
</a>
...
<div class="mb-7"><h4 class="fs-4 mb-8 mt-12 pt-lg-1">Payment Infomation</h4>
<div class="nav nav-tabs border-0">
<a class="btn btn-payment px-12 mx-2 py-6 me-7 my-3 nav-link" data-bs-toggle="tab" data-bs-target="#paypal-tab">
...
<label for="your-email" class="mb-5 fs-13px letter-spacing-01 fw-bold text-uppercase">Email</label>
<input name="paymentEmail" type="email" class="form-control" id="your-email" placeholder="Your email" required>
</div>
</div>
<div class="row">
<div class="col-md-6">
<label for="password" class="mb-5 fs-13px letter-spacing-01 fw-semibold text-uppercase">Password</label>
<input name="paymentPassword" type="password" class="form-control" id="password" placeholder="******" required>
</div>
</div>
</div>
</div>
...
<div class="col-md-6 mb-md-0 mb-7">
<label class="mb-5 fs-13px letter-spacing-01 fw-semibold text-uppercase opacity-0 d-md-block d-none">Year</label>

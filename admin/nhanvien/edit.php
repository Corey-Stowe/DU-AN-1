                                                    ...
                                                    <div class="form-item vertical mb-0 max-w-[700px]">
                                                        ...
                                                        <div>
                                                            <span class="input-wrapper">
                                                                ...
                                                                <input class="input pl-8" type="text" name="name"
                                                    ...
                                                    <div class="form-item vertical mb-0 max-w-[700px]">
                                                        ...
                                                        <div>
                                                            <span class="input-wrapper">
                                                                ...
                                                                <input class="input pl-8" type="text" name="matkhau"
                                                                    autocomplete="off" placeholder="mật khẩu truy cập">
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-item vertical mb-0 max-w-[700px]">
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <input class="upload-input draggable" type="file" title=""
                                                                value="" name="avt"
                                                            ...
                                                            <div class="max-w-full flex flex-col px-4 py-2 justify-center items-center"
                                                                ...
                                                                <div class="my-16 text-center"
                                                                    ...
                                                                    <p class="font-semibold">
                                                                        <span class="text-gray-800 dark:text-white">kéo
                                                                            hoặc thả ảnh hoặc</span>
                                                                        <span class="text-blue-500">duyệt</span>
                                                                    </p>
                                                                    <p class="mt-1 opacity-60 dark:text-white">Hỗ trợ:
                                                                        jpeg, png</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-item vertical mb-0 max-w-[700px]">
                                                    ...
                                                    <div>
                                                        <span class="input-wrapper">
                                                            ...
                                                            <input class="input pl-8" type="text" name="manv"
                                                                autocomplete="off" placeholder="Mã nhân viên">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-item vertical mb-0 max-w-[700px]">
                                                    ...
                                                    <div>
                                                        <span class="input-wrapper">
                                                            ...
                                                            <input class="input pl-8" type="text" name="diachi"
                                                                autocomplete="off" placeholder="Địa chỉ ">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-item vertical mb-0 max-w-[700px]">
                                                    ...
                                                    <div>
                                                        <span class="input-wrapper undefined">
                                                            ...
                                                            <input class="input pl-8" type="text" name="sdt"

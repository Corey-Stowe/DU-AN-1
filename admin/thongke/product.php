                ...
                <div class="card card-layout-frame">
                    <div class="card-body">
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                <h3 class="font-bold">
                                    <span><?php echo number_format($toal_oder_revenue['ket_qua_tru'], 0, ',', '.').'đ' ?>
                                    </span>
                                </h3>
                            ...
                            <table class="table-default table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="cursor-pointer select-none font-semibold hover:text-indigo-600">#<?php echo $ma_don_hang?></span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="flex items-center">
                                                ...
                                                <span class="ml-2 rtl:mr-2 capitalize font-semibold text-yellow-500">Cần
                                                    Xác thực</span>
                                            </div>
                                        </td>
                                        <?php
                                        ...
                                        <td>
                                            <div class="flex items-center">
                                                ...
                                                <span class="ml-2 rtl:mr-2 capitalize font-semibold text-emerald-500">Đã
                                                    Thanh Toán</span>
                                            </div>
                                        </td>
                                        <?php
                                        ...
                                        <td>
                                            <div class="flex items-center">
                                                ...
                                                <span class="ml-2 rtl:mr-2 capitalize font-semibold text-red-500">Chưa
                                                    Thanh toán</span>
                                            </div>
                                        </td>
                                        <?php
                                        ...
                                        <td>
                                            <div class="flex items-center">
                                                <span class="badge-dot bg-red-500"></span>
                                                <span class="ml-2 rtl:mr-2 capitalize font-semibold text-red-500">Đã
                                                    Hủy</span>
                                            </div>
                                        </td>
                                        <?php
                                        ...
                                        <td>
                                            <span
                                                class="font-semibold"><?php echo number_format($tong_gia_don_hang_giam, 0, ',', '.').'đ' ?></span>
                                        </td>
                                        <td>
                                            <div class="flex justify-end text-lg">
                                                <span class="cursor-pointer p-2 hover:text-indigo-600"
                                                    data-bs-toggle="tooltip" data-bs-title="Chi tiết">
                                                    <a
                                                        href="admin.php?act=ctdonhang&ma_don_hang=<?php echo $ma_don_hang?>">
                                                ...
                                                <span class="cursor-pointer p-2 hover:text-red-500"
                                                    data-bs-toggle="tooltip" data-bs-title="Đơn hàng đã được hủy">
                                                    <svg stroke="currentColor" fill="none" stroke-width="2"
                                                ...
                                                <?php
                                                                            ...
                                                                            ?>
                                                <span class="cursor-pointer p-2 hover:text-red-500"
                                                    data-bs-toggle="tooltip" data-bs-title="Hủy và xóa đơn hàng này">
                                                    <a
                                                        href="admin.php?act=sethuydon&ma_don_hang=<?php echo $ma_don_hang?>">
                                                        <svg stroke="currentColor" fill="none" stroke-width="2"
                                                            viewBox="0 0 24 24" aria-hidden="true" height="1em"
                                                            width="1em" xmlns="http://www.w3.org/2000/svg">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <div class="flex items-center gap-2">
                                                <span class="avatar avatar-rounded avatar-md">
                                                    <img class="avatar-img avatar-rounded"
                                                        src="../image/<?php echo $anh?>" loading="lazy" />
                                                </span>
                                                <span class="font-semibold"><?php  echo $ten_san_pham ?></span>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span class="cursor-pointer p-2 hover:text-indigo-600">
                                                <a
                                                    href="admin.php?act=chitietsp&ma_san_pham=<?php echo $ma_san_pham ?>">

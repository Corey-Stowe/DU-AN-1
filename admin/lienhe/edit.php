                                                    ...
                                                    <div>
                                                        <span class="input-wrapper">
                                                            ...
                                                            <input class="input pl-8" type="text"
                                                                name="ten_doanh_nghiep" autocomplete="off"
                                                                placeholder="Name"
                                            ...
                                            <div class="col-span-2">
                                                <div class="form-item vertical mb-0 max-w-[700px]">
                                                    <div
                                                        ...
                                                        <span
                                                            class="avatat-lg border-2 border-white dark:border-gray-800 shadow-lg"
                                                ...
                                                <div class="form-item vertical mb-0 max-w-[700px]">
                                                    ...
                                                    <div>
                                                        <span class="input-wrapper">
                                                            ...
                                                            <input class="input pl-8" type="text" name="dia_chi"
                                                                autocomplete="off" placeholder="Title"

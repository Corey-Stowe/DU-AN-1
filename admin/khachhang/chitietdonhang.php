            ...
            <header class="card-header bg-transparent p-7">
                <div class="row align-items-center">
                    <div class="col-md-6 mb-lg-0 mb-6">
                        <span class="d-inline-block"><i class="far fa-calendar me-3"></i>Wed, Aug 13, 2020, 4:34PM
                        </span>
                        <br>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center flex-nowrap">
                                                ...
                                                <a href="../shop/product-details-v1.html" title="Flowers cotton dress"
                                                    class="ms-6">
                                                    <p class="fw-semibold text-body-emphasis mb-0">Flowers cotton dress
                                                    </p>
                                                </a>
                                            </div>
                                        </td>
                                            ...
                                            <div class="d-flex align-items-center flex-nowrap">
                                                <a href="../shop/product-details-v1.html" title="Hoodie with pocket">
                                                    <img src="#"
                                                        ...
                                                        alt="Hoodie with pocket" class="lazy-image" width="60"
                                                        height="80">
                                                </a>
                                                <a href="../shop/product-details-v1.html" title="Hoodie with pocket"
                                                    class="ms-6">
                                                    <p class="fw-semibold text-body-emphasis mb-0">Hoodie with pocket
                                                    </p>
                                                </a>
                                            </div>
                                        </td>
                                            ...
                                            <div class="d-flex align-items-center flex-nowrap">
                                                <a href="../shop/product-details-v1.html"
                                                    ...
                                                    <img src="#"
                                                        ...
                                                        alt="Oversize cotton sweatshirt" class="lazy-image" width="60"
                                                        height="80">
                                                </a>
                                                <a href="../shop/product-details-v1.html"
                                                    title="Oversize cotton sweatshirt" class="ms-6">
                                                    <p class="fw-semibold text-body-emphasis mb-0">Oversize cotton
                                                        sweatshirt</p>
                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center flex-nowrap">
                                                ...
                                                <a href="../shop/product-details-v1.html"
                                                    ...
                                                    <p class="fw-semibold text-body-emphasis mb-0">Striped cotton-blend
                                                        sweatshirt</p>
                                                </a>
                                            </div>
                                        </td>

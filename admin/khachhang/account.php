                        ...
                        <div class="tab-pane fade show active" id="tab-profile">
                            <form action="index.php?act=account" method="POST" enctype="multipart/form-data">
                                <div class="form-container vertical">
                                        ...
                                        <div class="col-md-9">
                                            <div class="upload upload-draggable hover:border-primary-600 min-h-fit">
                                                <input class="form-control-file upload-input draggable" type="file"
                                                    title="" value="" name="avt" onchange="previewImagesindex(event)">
                                            ...
                                            <span
                                                ...
                                                data-avatar-size="60">
                                                <img class="avatar-img avatar-circle" src="image/<?php echo $avt?>"
                                                    loading="lazy">
                                            </span>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                                        <label for="name" class="col-md-3 col-form-label font-weight-bold">Số Điện
                                            Thoại</label>
                                        <div class="col-md-9">
                                            <div class="input-group">

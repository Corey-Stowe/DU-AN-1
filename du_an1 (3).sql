...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2023 at 11:22 AM
...
(1, 'mùa đông không sợ lạnh đã có hoodie', 'F_EvePAaEAAyXbK.jpg', 'masp=6', '2023-11-18 18:05:18'),
(2, 'banner2', 'nobanner.jpg', '-', '2023-11-18 18:05:23'),
(3, 'banner3', 'nobanner.jpg', '-', '2023-11-18 18:05:26'),
(4, 'banner4', 'nobanner.jpg', '-', '2023-11-18 18:05:27');
...
(4, 1, 6, 'Sản phầm đẹp', 'Không có ảnh', '2023-11-23', 0),
(5, 1, 6, 'Sản phầm đẹp', '019ba270c654412ce7a72e4b055fefc9.jpg', '2023-11-23', 0),
(6, 1, 6, 'hay', 'Không có ảnh', '2023-11-23', 0);
...
CREATE TABLE `don_hang` (
  ...
  `ma_khach_hang` int(11) DEFAULT NULL,
  `trang_thai_don` tinyint(2) DEFAULT NULL COMMENT '0 - Cần xác thực , 1 - Đã thanh toán, 2 - Chưa thanh toán, 3- Đã Hủy',
...
INSERT INTO `don_hang` (`ma_don_hang`, `ngay_dat_hang`, `ma_khach_hang`, `trang_thai_don`, `trang_thai_ship`, `phuong_thuc_thanh_toan`, `ghi_chu`, `ghi_chu_kh`) VALUES
(1, '2023-11-18', 3, 1, 0, 0, '', 'Hoodie chọn mình size XL và mầu đỏ nhé\r\nCả quần cũng vậy'),
(2, '2023-11-17', 4, 0, 0, 2, 'Đơn hàng bị treo vì khách hàng chưa cập nhật thông tin', '0'),
(3, '2023-11-01', 6, 3, 0, 1, '', '0'),
(4, '2023-11-20', 6, 1, 0, 3, '', '');
...
(5, 'Khách hàng 5', '', '', 'khachhang4@webmaster.com', '12345', '', 2, 3, NULL, 0),
...
(1, 'XShop', '17, Trịnh Văn Bô , Nam Từ Liêm, Hà Nội', 981234567, '', 'xshop@webmaster.com', 0);
...
(1, 'NEWMEM20', 'Giảm 20.000 VND Cho khách hàng mới', 20000, '2023-12-31', 0);
...
--
ALTER TABLE `binh_luan`
  MODIFY `ma_binh_luan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `chi_tiet_don_hang`
--
ALTER TABLE `chi_tiet_don_hang`
  MODIFY `ma_chi_tiet_don_hang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `ma_giam_gia`
  MODIFY `id_giam_gia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
